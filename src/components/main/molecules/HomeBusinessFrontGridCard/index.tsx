...
import { IHomeBusinessFrontGridCard } from './HomeBusinessFrontGridCard.interface'

const HomeBusinessFrontGridCard = ({
  src,
  alt,
  title,
  description,
  link,
}: IHomeBusinessFrontGridCard): JSX.Element => {
  return (
    <div
      className={twMerge(
...
export { HomeBusinessFrontGridCard }
