...
import { THeaderMainDropDownSocialMedia } from '../HeaderDropDownSocialMedia.interface'
...
export type TSocialMediaInfo = {
  [key in THeaderMainDropDownSocialMedia]: ISocialMediaRenderInfo
}
...
export const headerMainDropDownSocialMediaProps = {
  socialMediaInfo,
}
