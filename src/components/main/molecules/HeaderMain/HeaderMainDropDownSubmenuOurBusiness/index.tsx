...
import { IHeaderMainDropDownSubmenuOurBusiness } from './HeaderMainDropDownSubmenuOurBusiness.interface'

const HeaderMainDropDownSubmenuOurBusiness = ({
  submenu,
  titleClassName,
}: IHeaderMainDropDownSubmenuOurBusiness): JSX.Element[] => {
...
export { HeaderMainDropDownSubmenuOurBusiness }
