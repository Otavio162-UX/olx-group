import { IHomeBusinessFrontGridCard } from '@/components/main/molecules/HomeBusinessFrontGridCard/HomeBusinessFrontGridCard.interface'
import { InternalRoutes } from '@/routes/routes'

export const homeBusinessFrontGrid: IHomeBusinessFrontGridCard[] = [
  {
