...
import { FooterMainLinkTab } from '../../../molecules/FooterMain/FooterMainLinkTab'
import { IFooterMainTabs } from './FooterTabs.interface'

const FooterMainTabs = ({ navigationList }: IFooterMainTabs): JSX.Element => {
  return (
    <div
      className={twMerge(
