import { IButtonCollapsibleProps } from '@/components/molecules/ButtonCollapsible/ButtonCollapsible.interface'
...
export const headerDropDownOurBusinessProps: IHeaderDropDownOurBusinessProps = {
  buttonIconProps: {
